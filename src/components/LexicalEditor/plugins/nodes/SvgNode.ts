...
export class SvgNode extends DecoratorNode {
    ...
    static clone(node) {
        return new SvgNode(node.__svg, node.__x, node.__y, node.__width, node.__height, node.__key);
    }
    // getters and setters
    setX(x) {
    ...
    decorate() {
        return (_jsx(MoveableSvg, { svg: this.__svg, x: this.__x, y: this.__y, width: this.__width, height: this.__height, nodeKey: this.__key }));
    }
}
function MoveableSvg({ svg, x, y, width, height, nodeKey }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { ref: ref, draggable: true, onDragStart: (e) => {
                ...
                }, dangerouslySetInnerHTML: { __html: svg } }), _jsx(Moveable, { target: ref, draggable: true, resizable: true, keepRatio: false, onDragStart: (e) => {
