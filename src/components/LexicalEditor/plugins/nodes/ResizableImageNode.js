...
export class ResizableImageNode extends DecoratorNode {
    ...
    static clone(node) {
        return new ResizableImageNode(node.__src, node.__altText, node.__width, node.__height, node.__originalAspectRatio, node.__key);
    }
    ...
    decorate() {
        return (_jsx(ResizableImageComponent, { src: this.__src, altText: this.__altText, width: this.__width, height: this.__height, nodeKey: this.__key }));
    }
}
/**
 ...
 */
export function $createResizableImageNode({ src, altText = "", width = 300, height = 200, originalAspectRatio, }) {
    return new ResizableImageNode(src, altText, width, height, originalAspectRatio ?? width / height);
}
/**
...
function ResizableImageComponent({ src, altText, width, height, nodeKey }) {
    ...
    const originalAspectRatioRef = useRef(editor.getEditorState().read(() => {
        ...
        function onMouseMove(e) {
            editor.update(() => {
                ...
                if (currentHandle === "top" || currentHandle === "bottom") {
                    ...
                    const factor = currentHandle === "left" ||
    ...
    return (_jsx("div", { style: {
            ...
            maxWidth: "100%", // allow container to shrink on small screens
        }, children: _jsxs("div", { style: { position: "relative", width: "100%", paddingTop: `${paddingPercentage}%` }, children: [lockedBy && lockedBy !== userName && (_jsx("div", { className: "locked-overlay", style: { position: "absolute", top: 0, left: 0 }, children: lockedBy })), _jsx("img", { src: src, alt: altText, draggable: true, onDragStart: (e) => {
                    ...
                    }, onClick: onClickImage, onLoad: onImageLoad, style: {
                        position: "absolute",
                        top: 0,
                        left: 0,
                        width: "100%",
                    ...
                    } }), isSelected && isFocused && !isLocked && (_jsxs("div", { style: {
                        position: "absolute",
                        top: 0,
                        left: 0,
                        width: "100%",
                        ...
                        pointerEvents: "none",
                    }, children: [_jsx("div", { style: handleStyle("top", "left"), onMouseDown: (e) => handleMouseDown(e, "top-left") }), _jsx("div", { style: handleStyle("top", "center"), onMouseDown: (e) => handleMouseDown(e, "top") }), _jsx("div", { style: handleStyle("top", "right"), onMouseDown: (e) => handleMouseDown(e, "top-right") }), _jsx("div", { style: handleStyle("middle", "right"), onMouseDown: (e) => handleMouseDown(e, "right") }), _jsx("div", { style: handleStyle("bottom", "right"), onMouseDown: (e) => handleMouseDown(e, "bottom-right") }), _jsx("div", { style: handleStyle("bottom", "center"), onMouseDown: (e) => handleMouseDown(e, "bottom") }), _jsx("div", { style: handleStyle("bottom", "left"), onMouseDown: (e) => handleMouseDown(e, "bottom-left") }), _jsx("div", { style: handleStyle("middle", "left"), onMouseDown: (e) => handleMouseDown(e, "left") })] }))] }) }));
}
