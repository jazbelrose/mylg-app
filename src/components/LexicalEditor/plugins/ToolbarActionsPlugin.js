...
import { SET_FONT_FAMILY_COMMAND, SET_FONT_SIZE_COMMAND, SET_TEXT_COLOR_COMMAND, SET_BG_COLOR_COMMAND, OPEN_IMAGE_COMMAND, OPEN_FIGMA_COMMAND, TOGGLE_SPEECH_COMMAND, } from "../commands";
export default function ToolbarActionsPlugin({ registerToolbar }) {
    ...
    useEffect(() => {
        ...
        const actions = {
            ...
            onFontSizeChange: (value) => editor.dispatchCommand(SET_FONT_SIZE_COMMAND, `${value}px`),
            onFontColorChange: (e) => editor.dispatchCommand(SET_TEXT_COLOR_COMMAND, e.target.value),
            onBgColorChange: (e) => editor.dispatchCommand(SET_BG_COLOR_COMMAND, e.target.value),
