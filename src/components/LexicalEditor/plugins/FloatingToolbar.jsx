...
const FloatingToolbar = ({ editorRef }) => {
  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      >
        <i style={iconStyle(BoldIcon, isBold)} />
      </button>
      ...
      >
        <i style={iconStyle(ItalicIcon, isItalic)} />
      </button>
      ...
      >
        <i style={iconStyle(UnderlineIcon, isUnderline)} />
      </button>
      ...
      >
        <i style={iconStyle(StrikeThroughIcon, isStrikethrough)} />
      </button>
      ...
      {isLinkEditMode ? (
        <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
          <input
            ref={inputRef}
            type="text"
            value={tempLinkUrl} // Use temporary state for the input value
            onChange={(e) => {
          ...
          <button
            ...
            disabled={!tempLinkUrl.trim()} // Disable if tempLinkUrl is empty
          >
            <i style={iconStyle(CheckIcon, tempLinkUrl.trim())} />
          </button>
          <button
            type="button"
            ...
            style={smallButtonStyle}
          >
            <i style={iconStyle(CrossIcon, true)} />
          </button>
        </div>
      ) : linkUrl ? (
        <div
        ...
        >
          ...
          <button
            ...
            style={smallButtonStyle}
          >
            <i style={iconStyle(PenIcon, true)} />
          </button>
          ...
          <button
            ...
            style={smallButtonStyle}
          >
            <i style={iconStyle(TrashIcon, true)} />
          </button>
        </div>
      ) : (
        <button
...
>
  <i style={iconStyle(LinkIcon, linkUrl)} />
</button>
      )}
    </div>,
    document.body
