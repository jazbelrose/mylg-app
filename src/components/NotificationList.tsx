...
const NotificationList: React.FC<NotificationListProps> = ({
  ...
  const { allUsers, projects } = useData() as any;
  ...
  return (
    <ul className="notifications-list">
      {notifications.map((notif, idx) => {
        const sender = allUsers.find((u: any) => u.userId === notif.senderId) || {};
        const project = projects.find((p: any) => p.projectId === notif.projectId);
