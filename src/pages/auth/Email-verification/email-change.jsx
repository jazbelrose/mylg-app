  ...
  return (
    <div className={styles.authPage}>
      <div className={styles.authCard}>
        ...
        <form className={styles.authForm} onSubmit={e => {e.preventDefault(); handleConfirmAttribute();}}>
          <div className={styles.field} style={{display:'flex',justifyContent:'center',gap:'8px'}}>
          ...
          <button type="submit" className={`${styles.button} ${styles.primary}`} style={{marginTop:'24px',width:'100%'}}>
            Validate
          </button>
        </form>
