...
const Nocco = () => {
        ...
        "hasPart": [
            {
                ...
                "description": "A dynamic space designed for influencers and guests to engage with the NOCCO brand experience."
            },
            {
                "@type": "CreativeWork",
                "name": "Product Animation",
                "description": "High-quality renderings and animations showcasing NOCCO products."
            },
            {
                "@type": "CreativeWork",
                "name": "Event Hosting",
                "description": "A venue designed for filming, events, and brand activations."
            }
        ]
    };
    const images = [
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Helmet, { children: [_jsx("title", { children: pageTitle }), _jsx("meta", { name: "description", content: pageDescription }), _jsx("link", { rel: "canonical", href: canonicalUrl }), _jsx("meta", { property: "og:title", content: pageTitle }), _jsx("meta", { property: "og:description", content: pageDescription }), _jsx("meta", { property: "og:image", content: ogImage }), _jsx("meta", { property: "og:url", content: canonicalUrl }), _jsx("meta", { property: "og:type", content: "website" }), _jsx("meta", { name: "twitter:card", content: "summary_large_image" }), _jsx("meta", { name: "twitter:title", content: pageTitle }), _jsx("meta", { name: "twitter:description", content: pageDescription }), _jsx("meta", { name: "twitter:image", content: ogImage }), _jsx("script", { type: "application/ld+json", children: JSON.stringify(structuredData) })] }), _jsxs("div", { className: `${opacityClass} ${isModalOpen ? 'no-scroll' : ''}`, children: [_jsx("div", { className: "svg-overlay", children: _jsx("svg", { viewBox: "0 0 1000 1000", preserveAspectRatio: "none", children: _jsx("path", { id: "revealPath", d: "M0,1005S175,995,500,995s500,5,500,5V0H0Z" }) }) }), _jsx("div", { className: "workpage-heading", children: _jsx(InlineSvg, { src: "https://d2qb21tb4meex0.cloudfront.net/svg/nocco/noccoheader.svg", onReady: () => setSvgReady(true) }) }), _jsxs("div", { className: "rendering-layout", children: [_jsx(InlineSvg, { src: "https://d2qb21tb4meex0.cloudfront.net/svg/nocco/row1.svg", className: "rendering-row" }), _jsx(InlineSvg, { src: "https://d2qb21tb4meex0.cloudfront.net/svg/nocco/row2.svg", className: "rendering-row" }), _jsxs("div", { className: "rendering-row-img", children: [_jsx("div", { className: "img-container", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/52.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "auto", onClick: () => openModal(0), style: { cursor: "pointer" } }) }), _jsx("div", { className: "img-container", children: _jsxs("video", { width: "100%", height: "auto", loop: true, autoPlay: true, muted: true, playsInline: true, children: [_jsx("source", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/00.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] }) })] })] }), _jsx("div", { className: "rendering-ticker-section", children: _jsx(Ticker, { lines: tickerLines, fontSizes: ["25vh"], padding: "2vh" }) }), _jsxs("div", { className: "rendering-layout", children: [_jsx("div", { className: "rendering-row", children: _jsx(InlineSvg, { src: "https://d2qb21tb4meex0.cloudfront.net/svg/nocco/row4.svg", style: { width: '100%', height: '100%' } }) }), _jsx("div", { className: "rendering-row-video", children: _jsx("div", { className: "bb-video-container", style: { borderRadius: '0px' }, children: _jsxs("video", { width: "100%", height: "100%", loop: true, autoPlay: true, muted: true, playsInline: true, style: { borderRadius: '0' }, children: [_jsx("source", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/01.mp4", type: "video/mp4" }), "Your browser does not support the video tag."] }) }) }), _jsxs("div", { className: "rendering-row-img", children: [_jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/01.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(1), style: { cursor: "pointer" } }) }), _jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/02.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(2), style: { cursor: "pointer" } }) })] }), _jsxs("div", { className: "rendering-row-img", children: [_jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/04.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(3), style: { cursor: "pointer" } }) }), _jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/05.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(4), style: { cursor: "pointer" } }) })] }), _jsxs("div", { className: "rendering-row-img", children: [_jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/03.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(5), style: { cursor: "pointer" } }) }), _jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/04.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(6), style: { cursor: "pointer" } }) })] }), _jsx("div", { className: "rendering-row-img", children: _jsx("div", { className: "img-container ", children: _jsx("img", { src: "https://d1cazymewvlm0k.cloudfront.net/26-NOCCO/06.jpg", loading: "lazy", alt: "nocco image", width: "100%", height: "100%", onClick: () => openModal(7), style: { cursor: "pointer" } }) }) })] }), _jsx("div", { className: "rendering-layout" }), _jsxs("div", { className: "rendering-infosection", children: [_jsx(InfoSection, {}), _jsx("hr", { style: { opacity: "1", color: "fff", height: "2px", backgroundColor: "#fff", margin: "0.5rem", } }), _jsx("div", { className: "single-ticker-section", children: _jsx(SingleTicker, {}) })] }), _jsx(ReactModal, { isOpen: isModalOpen, onRequestClose: closeModal, className: "modal-content", overlayClassName: "modal", ariaHideApp: false, children: _jsx("div", { className: "modal-content", onTouchStart: handleTouchStart, onTouchMove: handleTouchMove, onTouchEnd: handleTouchEnd, children: _jsx("img", { src: images[currentIndex], alt: `Image ${currentIndex}`, className: "modal-image" }) }) })] })] }));
};
