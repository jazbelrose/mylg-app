            ...
            <div className="rendering-layout">
                ...
                <div className="rendering-row-img" style={{ display: 'flex', width: '100%' }}>
                    ...
                    <div className="img-container" style={{ flex: '1' }}>
                        <InlineSvg src="https://d2qb21tb4meex0.cloudfront.net/svg/keyssoulcare/row5.svg" className="rendering-row" style={{ width: '100%', height: 'auto' }} />
                    </div>
                ...
                <div className="rendering-row-img" style={{ display: 'flex', width: '100%' }}>
                    ...
                    <div className="img-container" style={{ flex: '1' }}>
                        <InlineSvg src="https://d2qb21tb4meex0.cloudfront.net/svg/keyssoulcare/row7.svg" className="rendering-row" style={{ width: '100%', height: 'auto' }} />
                    </div>
