...
const AFLowerBath = () => {
    ...
    const galleryRefs = useRef([]); // fade-in items
    ...
    useLayoutEffect(() => {
        ...
        if (headerSvgRef.current) {
            ...
            tl.fromTo(st1, { opacity: 0, y: -50 }, { opacity: 1, y: 0, duration: 0.1, stagger: 0.1 }).fromTo(st2, { scale: 0 }, { scale: 1, duration: 1, stagger: 0.1, ease: "elastic.out(1, 0.3)" }, "-=0.4");
        }
        return () => tl.kill();
    }, [svgReady]);
    ...
    if (isLoading) {
        return _jsx("div", {}); // your loader if any
    }
    return (_jsxs(_Fragment, { children: [_jsxs(Helmet, { children: [_jsx("meta", { name: "robots", content: "noindex, nofollow" }), _jsx("title", { children: "A Flower Bath - *MYLG!*" })] }), _jsxs("div", { ref: pageScopeRef, className: `${opacityClass} ${isModalOpen ? "no-scroll" : ""}`, children: [_jsx("div", { className: "svg-overlay", children: _jsx("svg", { viewBox: "0 0 1000 1000", preserveAspectRatio: "none", children: _jsx("path", { id: "revealPath", d: "M0,1005S175,995,500,995s500,5,500,5V0H0Z" }) }) }), _jsx("div", { className: "workpage-heading", children: _jsx(InlineSvg, { src: "https://d2qb21tb4meex0.cloudfront.net/svg/aflowerbathheader.svg", onReady: (el) => {
                                headerSvgRef.current = el;
                                setSvgReady(Boolean(el));
                            } }) }), _jsx("div", { className: "container-restricted", children: _jsx("div", { className: "mb-5 po_items_ho", children: imageUrls.map((url, i) => (_jsx("div", { className: "po_item", ref: (el) => (galleryRefs.current[i] = el), children: _jsx("div", { className: "img-wrapper", children: _jsx("img", { src: url, alt: `Image ${i + 1}`, className: "d-block w-100", style: {
                                            objectFit: "cover",
                                            width: "100%",
                                            height: "100%",
                                            cursor: "pointer",
                                        }, onClick: () => openModal(i) }) }) }, i))) }) }), _jsxs("div", { className: "rendering-infosection", children: [_jsx("hr", { style: {
                                    opacity: "1",
                                    color: "fff",
                                    height: "2px",
                                    backgroundColor: "#fff",
                                    margin: "0.5rem",
                                } }), _jsxs("div", { className: "rendering-infosection", children: [_jsx(InfoSection, {}), _jsx("hr", { style: {
                                            opacity: "1",
                                            color: "fff",
                                            height: "2px",
                                            backgroundColor: "#fff",
