...
const BudgetComponent = require('../BudgetComponent.js').default;
beforeEach(() => {
...
test('shows headerBallPark when no line items', () => {
    const { rerender } = render(_jsx(BudgetComponent, { activeProject: { projectId: 'p1', title: 'Test' } }));
    ...
    rerender(_jsx(BudgetComponent, { activeProject: { projectId: 'p1', title: 'Test' } }));
