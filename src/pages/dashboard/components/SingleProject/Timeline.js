...
const Timeline = ({
  ...
  const progress = activeProject
    ? parseStatusToNumber(activeProject.status)
    : 0;
  ...
  return _jsxs(_Fragment, {
    children: [
      saving &&
        _jsx("div", {
          style: { color: "#FA3356", marginBottom: "10px" },
          children: "Saving...",
        }),
      _jsxs("div", {
              ...
              return _jsxs(
                "div",
                {
                  ...
                  children: [
                    _jsx("span", {
                      className: "label",
                      children: m.label.map((line, lineIdx) =>
                        _jsxs(
                          React.Fragment,
                          {
                            children: [
                              line,
                              lineIdx < m.label.length - 1 && _jsx("br", {}),
                            ],
                          },
                          lineIdx
                        )
                    ...
                    _jsx("span", {
                      className: `percentage-pill ${status}`,
                      children: `${m.threshold}%`,
                    }),
                  ],
                },
                m.id
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        _jsx("label", {
                          ...
                          children: `Milestone ${editingMilestoneIndex + 1}`,
                        }),
                        _jsx("input", {
