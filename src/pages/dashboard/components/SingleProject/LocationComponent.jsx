...
const LocationComponent = ({ activeProject, onActiveProjectChange }) => {
  ...
  return (
    <div className="column-5" style={{ position: "relative" }}>
      ...
      <Map
        ref={mapRef}
        location={location.lat && location.lng ? location : { lat: 0, lng: 0 }}
      ...
      <div className="map-control-buttons">
        <button className="map-control-button" onClick={openModal} aria-label="Edit location">
          <FaPencilAlt size={14} />
        </button>
        <button
      ...
      >
        ...
        <div className="modal-map" style={{ flex: 1, marginTop: "10px" }}>
          <Map
            location={
              modalLocation.lat && modalLocation.lng ? modalLocation : { lat: 0, lng: 0 }
            }
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "10px" }}>
          <button className="modal-button secondary" onClick={() => setIsModalOpen(false)}>
            Cancel
          </button>
