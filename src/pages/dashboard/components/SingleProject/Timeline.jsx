...
const Timeline = ({ parseStatusToNumber, activeProject, onActiveProjectChange }) => {
    ...
    const [updatedMilestoneTitles, setUpdatedMilestoneTitles] = useState(
    ...
    const milestoneTitles = defaultTitles.map((t, i) =>
        updatedMilestoneTitles[i] || t
    );
                    ...
                    {milestones.map((m, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className={`percentage-pill ${status}`}>
                                    {`${m.threshold}%`}
                                </span>
                            </div>
                        );
                    ...
                    >
                        ...
                        {editingMilestoneIndex !== null && (
                            <form
                                ...
                                onSubmit={handleUpdateMilestoneTitle}
                            >
                                <div className={styles.field}>
                                    <label className={styles.label}>{`Milestone ${
