  ...
  >
      ...
      <div className='newProject-dashboard-layout' style={{ marginBottom: '5px' }}>
        <div className="new-project-col1" style={{ marginRight: '5px' }}>
          <NewProjectBudget budget={budget} setBudget={setBudget} style={{ marginBottom: '5px' }}/>
      ...
      <div className='newProject-dashboard-layout'>
        <NewProjectAddress location={location} setLocation={setLocation} address={address} setAddress={setAddress} style={{ marginRight: '5px' }} />
        <NewProjectDescription description={description} setDescription={setDescription} />
      </div>
      <div className='newProject-dashboard-layout'></div>
              ...
              >
                {isSubmitting ? (
                  <div className="submit-spinner">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="submit-spinner-svg">
                      <circle className="submit-spinner-path" cx="25" cy="25" r="20" fill="none" />
                    </svg>
                  </div>
                ) : validationMessage ? (
                  validationMessage
