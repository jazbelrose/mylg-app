  ...
  return (
    ...
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="An all-in-one platform to streamline your design projects with tools for management, collaboration, and presentation." />
        <meta name="keywords" content="creative tools, design presentation, project collaboration, 3D renders, MYLG, project management, creative support, design assistance, creative platform, rendering services" />
        <meta property="og:title" content="*MYLG!* - Creative to enhance your vision" />
        <meta property="og:description" content="Elevate your design projects with MYLG's all-in-one platform for professional rendering, presentation, and project execution." />
      ...
      <div className={`${opacityClass}`}>
        ...
        <HeroSection
          title="Streamline Your Creativity"
          subtitle="A platform to elevate your creative projects"
          ctaText="Get Started →"
          ctaLink="/register"
        />
        ...
        <div className="home-info-container" style={{ background: 'linear-gradient(to bottom, #000, #0c0c0c)', borderTopLeftRadius: '20px', borderTopRightRadius: '20px' }}>
          ...
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            <p style={{
              ...
              whiteSpace: 'normal',
              hyphens: 'manual'
            }}>*MYLG!* simplifies your creative process. Our all-in-one platform streamlines project management, communication, and presentation for your designs. Experience efficiency and elevate your creative effortlessly.</p>
        ...
        <div className="home-info-container">
          <div className="image-container" style={{ position: 'relative' }}>
            <img src="https://d1cazymewvlm0k.cloudfront.net/1-iPhone+14+Pro+MockupFINAL.jpg" alt="Our Platform" className="responsive-image" />
          </div>
        </div>
        <div className="home-info-container discover" >
          ...
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            ...
            }}><span className="drop-cap">D</span>iscover the all-in-one solution, designed to enhance creative. Upload ideas, sketches and initiate your projects effortlessly. Our intuitive dashboard lets you control your files, communicate with our team, track milestones, and access design files easily and conveniently.</p>
          </div>
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            <p style={{
              ...
              whiteSpace: 'normal',
              hyphens: 'manual'
            }}>Our dashboard system streamlines project communication. Set guidelines, budgets, upload assets, and collaborate with your team seamlessly all in one place. Save time, simplify the process, and accelerate your creative process.</p>
          </div>
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            <p style={{
              wordBreak: 'normal',
              ...
              The core belief of *MYLG!* is that the management of a project is as crucial as its design.
              The app offers a suite of tools to execute your projects with precision, including timeline coordination,
              resource allocation, stakeholder communication, drawings, and detailed execution plans.
            </p>
        ...
        <div className="home-info-container materializing">
          ...
          <div className="home-info-column">
            ...
            <h2>Materializing <br /> your vision <br /> with quality & speed.</h2>
          </div>
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            <video className="video-responsive" loop autoPlay muted playsInline>
              <source src="https://d1cazymewvlm0k.cloudfront.net/metalflower_RS+Camera_a.mp4" type="video/mp4" />
        ...
        <div className="home-info-container" style={{ padding: '20px 0 60px', backgroundColor: '#000000' }}>
          ...
          <div className="button-container platform" style={{ padding: '25px 100px 0px', margin: '30px 0px 0px' }}>
        ...
        <div className="home-info-container discover-1">
          ...
          <div className="home-info-column" style={{ padding: '0 25px' }}>
            <p style={{
              ...
              whiteSpace: 'normal',
              hyphens: 'manual'
            }}>*MYLG!* is an all-in-one platform with a built-in request for proposal dashboard system, speeding-up the process of design and visualizations. Provide us with your ideas we provide you with high quality, creative 2D & 3D design presentations with a fast turn-around.</p>
        ...
        <div className="home-info-container" style={{ paddingBottom: '25px' }}>
          <div className="home-info-column" style={{ padding: '0px 25px', minWidth: '350px' }}>
            <h2 style={{ margin: '0px', paddingBottom: '20px' }}>Let's<br /> get started</h2>
            <p style={{
              margin: '0',
              wordBreak: 'normal',
              overflowWrap: 'anywhere',
              whiteSpace: 'normal',
              hyphens: 'manual'
            }}>Unlock the door to a world of creativity with us. We’re committed to delivering high-quality, fast, and efficient design presentation and concept execution. Our focus is on artful visualizations, always dedicated to the finest details.</p>
            <div className="button-container platform2" style={{ padding: '0' }}>
              <ScrambleButton text="Sign-up →" to="/register" />
            </div>
          </div>
          <div className="sign-up-image" style={{ alignItems: "flex-end" }}>
            <img src="https://d2qb21tb4meex0.cloudfront.net/Iphone+14+mockup+sign+up.png" alt="Get Started" className="responsive-image2" />
          </div>
        </div>
      ...
      {window.innerWidth > 768 && <ScrollToTopButton />}
    </>
  );
};
