...
import styles from "@/pages/dashboard/BudgetPage/BudgetPage.module.css";
...
import QuickLinksComponent from "@/features/dashboard/components/QuickLinks/QuickLinks";
import FileManagerComponent from "@/pages/dashboard/components/SingleProject/FileManager";
import BudgetHeader from "../components/HeaderStats";
import BudgetFileModal from "../modals/BudgetFileModal";
import CreateLineItemModal from "../modals/CreateLineItemModal/CreateLineItemModal";
import EventEditModal from "@/pages/dashboard/BudgetPage/components/modals/EventEditModal/EventEditModal";
import RevisionModal from "@/pages/dashboard/BudgetPage/components/modals/RevisionModal/RevisionModal";
import BudgetChart from "@/pages/dashboard/BudgetPage/components/BudgetChart";
import BudgetToolbar from "@/pages/dashboard/BudgetPage/components/BudgetToolbar";
import BudgetItemsTable from "../components/BudgetTable";
import BudgetStateManager from "@/pages/dashboard/BudgetPage/components/BudgetStateManager";
import BudgetEventManager from "@/pages/dashboard/BudgetPage/components/BudgetEventManager";
import BudgetTableLogic from "@/pages/dashboard/BudgetPage/components/BudgetTableLogic";
import { BudgetProvider, useBudget } from "../context/BudgetProvider";
